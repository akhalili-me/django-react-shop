...
from ..models import State, Address, City
...
class AddressViewsTests(TestCase):
    def setUp(self):
        ...
        self.ADDRESS_RETRIVE_UPDATE_DELETE_URL = reverse(
            "shipment:address-retrieve-update-delete", args=[self.address.pk]
        )
    ...
    def test_address_retrieve_api(self):
        response = self.client.get(self.ADDRESS_RETRIVE_UPDATE_DELETE_URL)
    ...
    def test_address_update_api(self):
        ...
        response = self.client.patch(self.ADDRESS_RETRIVE_UPDATE_DELETE_URL, payload)
    ...
    def test_address_delete_api(self):
        response = self.client.delete(self.ADDRESS_RETRIVE_UPDATE_DELETE_URL)
