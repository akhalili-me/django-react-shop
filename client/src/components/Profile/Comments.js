...
const Comments = () => {
  ...
  return (
    <>
      <DeleteModal show={showDeleteModal} onSubmit={deleteComment} onClose={handleCloseModal} message={'Are you sure to delete this comment?'}/>
      <EditModal show={showEditModal} onClose={handleCloseModal} commentId={commentId} updateCommentState={updateCommentState}/>
            ...
            <Row>
              ...
              <Col md={2}>
                <ButtonGroup className='comment_buttons'>
                  <Button onClick={handleShowModal} data-commentid={comment.id} name='edit'  variant="warning">
                    <i class="fas fa-edit" style={{ pointerEvents: 'none' }}></i>
                  </Button>
                  <Button onClick={handleShowModal} data-commentid={comment.id} name='delete' variant="danger">
